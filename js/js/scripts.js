...
//slider 
const slidesReviews = document.querySelectorAll('.sliders-reviews'),
        slidesBooking = document.querySelectorAll('.sliders-booking'),
        prevReviews = document.querySelector('.tc-button-prev'),
        nextReviews = document.querySelector('.tc-button-next'),
        prevBooking =  document.querySelector('.ec-button-prev'),
        nextBooking = document.querySelector('.ec-button-next');
let slideIndex = 1;
...
prevReviews.addEventListener('click', () => { plusSlides(-1, slidesReviews) });
nextReviews.addEventListener('click', () => { plusSlides(1, slidesReviews) });

prevBooking.addEventListener('click', () => { plusSlides(-1, slidesBooking) });
nextBooking.addEventListener('click', () => { plusSlides(1, slidesBooking) });

showSlides(slideIndex, slidesReviews);
showSlides(slideIndex, slidesBooking);
